...
- **DON'T** try to do it `Pixel Perfect` - implement it the most `simple` way so it looks similar.jh
- When done check yourself using the [CHECKLIST](./checklist.md) when finished.
- Deploy and create a Pull Request with a [DEMO LINK](https://PrinceValue.github.io/layout_landing-page/).
